...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setMaximumSize(QSize(517, 522));
        MainWindow->setStyleSheet(QString::fromUtf8("#desktop * {\n"
"border-image:url(url(:/new/prefix1/photo1.jpg));\n"
"}"));
...
"}"));
        ...
        sizePolicy.setHeightForWidth(pushButton_LeftParenthesis->sizePolicy().hasHeightForWidth());
        pushButton_LeftParenthesis->setSizePolicy(sizePolicy);
        ...
        font2.setBold(false);
        font2.setWeight(50);
        pushButton_LeftParenthesis->setFont(font2);
...
"}"));
        ...
        sizePolicy.setHeightForWidth(pushButton_ClosingParenthesis->sizePolicy().hasHeightForWidth());
        pushButton_ClosingParenthesis->setSizePolicy(sizePolicy);
        pushButton_ClosingParenthesis->setMinimumSize(QSize(0, 0));
        pushButton_ClosingParenthesis->setBaseSize(QSize(0, 0));
        pushButton_ClosingParenthesis->setFont(font1);
...
"}"));
        ...
        pushButton_subtraction->setFont(font1);
...
"}"));
        ...
        sizePolicy.setHeightForWidth(pushButton_fraction->sizePolicy().hasHeightForWidth());
        pushButton_fraction->setSizePolicy(sizePolicy);
        ...
        font6.setWeight(50);
        pushButton_fraction->setFont(font6);
